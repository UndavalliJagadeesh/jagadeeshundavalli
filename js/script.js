...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // IMPORTANT: These constants must be defined BEFORE resizeCanvas() is called
  ...
  // Calculate experience from October 2024
  const startDate = new Date(2024, 9, 1); // October is month 9 (0-indexed)
  const now = new Date();
  ...
  if (experienceEl) {
    experienceEl.textContent = experienceText;
  }
